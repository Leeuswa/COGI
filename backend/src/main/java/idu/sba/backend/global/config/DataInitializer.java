...
public class DataInitializer implements CommandLineRunner {
    ...
    private void seedCourses() {
        courseRepository.saveAll(List.of(
                Course.of("BUG", "Java", "INFLEARN", "자바 예외 처리와 널 안전성",
                        "널과 예외를 다루는 기준을 잡는 강의", "https://www.inflearn.com/courses?s=자바%20예외"),
                Course.of("BUG", "Python", "UDEMY", "파이썬 디버깅 실전",
                        "흔한 런타임 오류를 추적하는 방법", "https://www.udemy.com/courses/search/?q=python%20debugging"),
                Course.of("SECURITY", null, "INFLEARN", "웹 보안 취약점 입문",
                        "인젝션과 권한 검증을 다룬다", "https://www.inflearn.com/courses?s=웹%20보안"),
                Course.of("PERFORMANCE", "Java", "UDEMY", "JPA 성능 튜닝",
                        "N+1과 지연 로딩을 잡는다", "https://www.udemy.com/courses/search/?q=jpa%20performance"),
                Course.of("CONVENTION", null, "INFLEARN", "클린 코드 네이밍",
                        "읽히는 이름을 짓는 기준", "https://www.inflearn.com/courses?s=클린%20코드"),
                // CODE_SMELL은 강의가 하나도 없어서 '구조 개선'만 약점인 사람은 추천이 통째로 비었다
                Course.of("CODE_SMELL", null, "INFLEARN", "리팩터링 입문",
                        "중복과 긴 메서드를 걷어내는 순서", "https://www.inflearn.com/courses?s=리팩터링"),
                Course.of("CODE_SMELL", null, "UDEMY", "Refactoring 실전",
                        "냄새를 찾아 구조를 바꾸는 패턴", "https://www.udemy.com/courses/search/?q=refactoring"),
                // 언어무관 보루 — Java/Python 외 언어에서도 최소 한 건은 뜨게 한다
                Course.of("BUG", null, "UDEMY", "디버깅의 기술",
                        "언어를 가리지 않는 원인 추적법", "https://www.udemy.com/courses/search/?q=debugging"),
                Course.of("PERFORMANCE", null, "INFLEARN", "성능 개선 기초",
                        "느린 코드를 재는 법부터", "https://www.inflearn.com/courses?s=성능%20개선")));
    }
