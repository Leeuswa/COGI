...
export const mockNotifications = {
  team: [],
  member: [{
    id: 1, icon: '👥', link: '/app/team',
    title: 'Team Fable 초대',
    text: '팀장이 GitHub 아이디(@su-dev)로 초대했어요.\n수락하면 바로 팀에 합류됩니다.',
  }],
  user: [{
    id: 2, icon: '📧', link: '/app/team',
    title: 'Team Fable 초대',
    text: '이메일로 초대가 도착했어요.\nGitHub 연동을 마치면 합류할 수 있어요.',
  }, {
    id: 3, icon: '🎉', link: '/app/cards',
    title: '첫 학습 카드 도착',
...
export const mockTeam = {
  ...
  members: [
    { id: 1, name: '상연',   email: 'dev@fable.dev',    role: 'OWNER',  joinedAt: '2026-06-20' },
    { id: 2, name: '이수환', email: 'su@fable.dev',     role: 'MEMBER', joinedAt: '2026-06-22' },
    { id: 3, name: '홍성찬', email: 'hong@fable.dev',   role: 'MEMBER', joinedAt: '2026-06-23' },
  ],
