...
export const mockAccounts = [
  { loginId: 'team',   password: '1234', role: 'USER',  name: '상연(팀장)', email: 'dev@fable.dev',    githubUsername: 'fable-dev' },
  { loginId: 'member', password: '1234', role: 'USER',  name: '이수환',     email: 'su@fable.dev',     githubUsername: 'su-dev' },
  { loginId: 'user',   password: '1234', role: 'USER',  name: '테스트유저', email: 'user@test.dev',    githubUsername: null },
  { loginId: 'admin',  password: '1234', role: 'ADMIN', name: '관리자',     email: 'admin@fable.dev',  githubUsername: 'fable-admin' },
];
